# =================================================================
# 🎮 app_reaction_game.py : 반응속도 게임 (Grove Yellow LED Button)
# =================================================================
...
# -----------------------------------------------------------------
# [3] main.py 인터페이스 (app_manager.REQUIRED_APP_ATTRS)
# -----------------------------------------------------------------
def read_dust_sensor():
    """
    main.py는 원래 센서 값을 읽는 용도로 이 함수를 부르지만, 이 앱은
    반응속도 게임이라 게임 상태를 갱신하는 용도로 재활용합니다. 반환
    형식(voltage, value)은 그대로 두고, value 자리에 최근 반응속도(ms)를
    넣어 대시보드 숫자 표시를 그대로 활용합니다.
    """
    _update_game()
